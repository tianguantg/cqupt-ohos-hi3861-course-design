...
//#define OLED_MODULE 
//#define SMOKE_ALARM 
//#define COMBUSTIBLE_GAS_MODULE 
//#define FINGERPRINT_MODULE 
//#define HEART_RATE_MODULE 
//#define TRIAXIAL_MODULE 
//#define GPS_MODULE 
//#define VOICE_MODULE 
...
#ifdef INFRARED_MODULE
    printf("============== infrared module ==============\r\n");
    infrared_adc_demo();
#endif
...
#ifdef COMBUSTIBLE_GAS_MODULE
    printf("============== combustible gas module ==============\r\n");
    combustible_gas_demo();
#endif

#ifdef FINGERPRINT_MODULE
    printf("============== fingerprint module ==============\r\n");
    //fingerprint_uart_demo();
    fingerprint_demo();
#endif

#ifdef HEART_RATE_MODULE
    printf("============== heart rate module ==============\r\n");
    heart_rate_detection_demo();
#endif

#ifdef TRIAXIAL_MODULE
    printf("============== triaxial module ==============\r\n");
    triaxial_demo();
#endif
